...
RUN apt-get update
RUN apt-get install libraspberrypi-bin gstreamer1.0 gstreamer1.0-tools gstreamer1.0-omx libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev libgssdp-1.0-dev v4l-utils wget ca-certificates build-essential
RUN apt-get upgrade
